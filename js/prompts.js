...
export function getReconnectPrompt(reason, context) {
  ...
  switch (reason) {
    case 'search': {
      ...
      return 'Току що потърси в телефона. Ето какво намери:\n' + results + '\n\n' +
        'Разкажи НАЙ-ВАЖНОТО от резултатите в 2-3 изречения — най-интересното или най-актуалното. ' +
        'После спомени НАБЪРЗО че има и други неща, но по-маловажни. НЕ изреждай всичко. НЕ чети дословно. ' +
        'Преразкажи с думите си, кратко и естествено. ' + summary + dk;
    }
    case 'silent':
